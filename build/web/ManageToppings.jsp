<%-- 
    ...
    Created on : 29-Nov-2019, 1:28:39 PM
    Author     : riley
        ...
        <div class="container">
            ...
            <div class="row">
                <div class="col-sm-6 text-center">
                    ...
                    <form method="post" id="myForm"  action="managetopping_proc">
                        <p>Name: <input type="text" name="name" maxlength="45" ></p><BR>
                        <p>Price: <input type="text" name="price"></p><BR>
                        <p><input type="submit" value="Add Topping!" ></p><br>
                    </form>
                </div>
                <div class="col-sm-6 text-center">
                    <h3>Current Available Toppings</h3>
                    <%
                        ArrayList<Toppings> toppings = ToppingsBL.getAllAvailableToppings();
                        if (toppings != null) {
                            for (Toppings t : toppings) {
                                out.println(t.getName() + " " + t.getPrice() + " <a href=\"managetopping_proc?topping=" + t.getToppingId() + "\">Delete</a><BR>");
                            }
                        } else {
                            out.println("<p>No Toppings Currently Available!</p>");
                        }
                    %>
